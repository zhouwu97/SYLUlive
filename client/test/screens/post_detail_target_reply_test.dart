        ...
        data: [
          {
            ...
            "author_id": 2,
            "author": {"id": 2, "nickname": "User2", "avatar": "http://example.com/avatar.png", "student_id": "2"},
          ...
          },
          {
            ...
            "author_id": 3,
            "author": {"id": 3, "nickname": "User3", "avatar": "http://example.com/avatar.png", "student_id": "3"},
            "created_at": "2026-01-01T00:00:00.000Z"
          },
          {
            "id": 3,
            ...
            "author_id": 4,
            "author": {"id": 4, "nickname": "User4", "avatar": "http://example.com/avatar.png", "student_id": "4"},
            "created_at": "2026-01-01T00:00:00.000Z"
          }
        ] as dynamic,
      );
...
class FakeAuthProvider extends Fake with ChangeNotifier implements AuthProvider {
...
class FakePostProvider extends Fake with ChangeNotifier implements PostProvider {
  @override
  void updatePostInCache(Post post) {}
}

class FakeThemeProvider extends Fake with ChangeNotifier implements ThemeProvider {
  @override
...
void main() {
  ...
  testWidgets('PostDetailScreen 滚动到目标子回复并高亮测试', (WidgetTester tester) async {
    ...
    // 检查是否包含目标回复的内容
    expect(find.text('Target second level reply'), findsOneWidget);
    ...
    final AnimatedContainer clearedContainer = tester.widget(find.ancestor(
      of: textFinder,
      matching: find.byType(AnimatedContainer),
    ).first);

    final BoxDecoration clearedDecoration = clearedContainer.decoration as BoxDecoration;
