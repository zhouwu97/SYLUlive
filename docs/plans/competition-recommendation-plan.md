...
- 被丢弃数从 219–279 降至 **45**，且全部为年级门真实不符（实测；审计阶段又发现并修复了年级门口径：
  该字段线上存的是学历层次而非年份，原 47 条里有 2 条「本科生」声明被误判为不符，详见
  `docs/reports/2026-09-18-competition-matching-coverage-audit.md` §七）。
