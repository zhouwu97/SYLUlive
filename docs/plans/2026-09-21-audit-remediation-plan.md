...
- [2026-09-22-release-readiness-round2.md](2026-09-22-release-readiness-round2.md)：
  工单请求级会话隔离、SecurityBlock method-aware、幂等三态与有界缓存、高危事件主动告警、
  学生身份盘点入口、发布清单的服务端边界，以及**发布口径**（哪些说法在补证据之前不能写）。
