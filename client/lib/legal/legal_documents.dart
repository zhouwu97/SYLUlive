...
三、撤销同意与账号注销
你可以在“隐私与数据权利”中使用密码确认撤销全部同意。撤销后，依赖授权的服务停止使用，教务凭证和设备推送标识会被清除；你仍可直接查阅自己的账户资料和授权记录。也可以使用密码确认注销账号，注销后身份资料会被清除或匿名化。
...
四、你的权利
你可以在“隐私与数据权利”中直接查阅账户资料和授权记录、导出个人数据，并随时撤销全部同意。更正或删除特定信息、内容时，可提交请求并查看处理状态。
