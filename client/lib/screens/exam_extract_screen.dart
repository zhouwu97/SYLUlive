...
class _ExamExtractScreenState extends State<ExamExtractScreen> {
  ...
  Future<void> _loadScript() async {
    try {
      _scriptContent = await rootBundle.loadString(
        'assets/scripts/tampermonkey_script.js',
      );
      setState(() {});
    } catch (_) {}
  }
  ...
  Future<void> _shareFiles() async {
    ...
    try {
      ...
      // 提取HTML
      final htmlData = await rootBundle.load(
        'assets/yongzhiyunkao/convert_to_markdown.html',
      );
