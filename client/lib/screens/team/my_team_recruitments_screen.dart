  ...
  Widget _emptyList(String text, bool isDark) => Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Container(
            ...
            child: Icon(Icons.groups_2_outlined, size: 30, color: TeamUiTokens.accent(isDark)),
          ),
          const SizedBox(height: 16),
          Text(text,
              style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: TeamUiTokens.title(isDark))),
        ]),
      );
}
                    ...
                    final confirmed = await showDialog<bool>(
                          ...
                          builder: (dialogContext) => AlertDialog(
                            ...
                            actions: [
                              ...
                              FilledButton(
                                style: TeamUiTokens.primaryButtonStyle(Theme.of(context).brightness),
                                onPressed: () =>
