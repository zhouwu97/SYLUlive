...
abstract interface class SystemNotificationClient {
  ...
  factory SystemNotificationClient.current() {
    if (PlatformCapabilities.current.supportsSystemNotification) {
      if (AppPlatforms.current.isAndroid) {
        return AndroidSystemNotificationClient();
      }
    }
    return UnsupportedSystemNotificationClient();
  }
}
