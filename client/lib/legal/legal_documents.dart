...
三、撤销同意
你可以在“隐私与数据权利”中使用密码确认撤销全部同意。撤销后，依赖授权的服务停止使用，教务凭证和设备推送标识会被清除；你仍可直接查阅自己的账户资料和授权记录。
''',
  );
...
四、你的权利
你可以在“隐私与数据权利”中直接查阅账户资料和授权记录，无需提交人工申请；也可以随时撤销全部同意。撤销后，依赖授权的功能将停止使用，教务凭证和设备推送标识会被清除。
''',
  );
...
用户可以在“隐私与数据权利”中直接查阅账户资料和授权记录，并随时撤销同意。
''',
  );
...
处理目的仅限教务功能和身份核验，不用于公开展示、广告营销或向无关用户提供。撤销全部同意后，服务端将清除教务凭证和绑定资料，所有依赖授权的功能停止使用。
''',
  );
