...
void main() {
  group('ErkeCrypto', () {
    ...
    test('encrypts password and can be decrypted by matching private key if we had one', () {
      ...
      final encryptedBase64 = ErkeCrypto.encryptPassword(testPlaintext, testPublicKeyBase64);
