...
class MajorProvider extends ChangeNotifier {
  ...
  MajorProvider(this._dio, this._interactionService);
  ...
  Future<void> voteRating(int ratingId, String voteType) async {
    final result = await _interactionService.voteMajorRating(ratingId, voteType);
    if (result != null) {
...
class MajorProvider extends ChangeNotifier {
  ...
  Future<bool> reportRating(int ratingId, String reasonCode, String reason) async {
