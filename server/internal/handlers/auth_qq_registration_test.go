...
func TestQQEmailRegistrationKeepsChallengeAfterDuplicateEmail(t *testing.T) {
	...
	if err := db.AutoMigrate(&models.User{}, &models.UserLegalConsent{}, &models.EmailVerificationChallenge{}, &models.EmailVerificationRequest{}, &models.VerificationAttemptBucket{}); err != nil {
