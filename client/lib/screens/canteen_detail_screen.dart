...
class _CanteenDetailScreenState extends State<CanteenDetailScreen> {
  ...
  Future<void> _loadData() async {
    ...
    final data = await context
        ...
        .loadCanteenDetail(widget.canteenId);
    if (mounted) {
      setState(() {
        _canteenData = data;
        _isLoading = false;
                        ...
                        children: [
                          Card(
                            ...
                            child: Padding(
                              ...
                              child: Column(children: [
                                Text(_canteenData!['canteen']['name'],
                          ...
                          if (_canteenData!['ratings'] != null &&
                              (_canteenData!['ratings'] as List)
                                  .isNotEmpty) ...[
                            Text('${_canteenData!['rating_count']}人评价',
                                style: TextStyle(
                                    fontSize: 16,
                                    fontWeight: FontWeight.bold,
                                    color: isDark
                    ...
                    onPressed: _star == 0
                        ...
                        : () async {
                            final success = await context
                                .read<CanteenProvider>()
                                .rateCanteen(widget.canteenId, _star,
                                    _commentCtrl.text, _ratingImages);
                            if (mounted) {
